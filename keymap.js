...
["control+alt+shift+c", {help: "all cells in row become column header cells", command: c => c.toggleHeader("row")}],
["control+alt+shift+r", {help: "all cells in column become row header cells", command: c => c.toggleHeader("column")}],
